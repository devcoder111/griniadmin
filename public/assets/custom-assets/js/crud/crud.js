...
//Ji
    ...
    function getList(page=1){
        ...
        var keyword = encodeURIComponent(document.getElementById("keyword").value);
        var ship_type = document.getElementById("ship_type").value;
        var column= document.getElementById("active_sort_column").value;
        var column_order= document.getElementById("active_sort_by").value;
         var order_date_filter=document.getElementById("order_date_filter").value;
         var ajaxTime= new Date().getTime();
          $('#loader').removeClass('hidden');
        $.ajax({
            type: "GET",
            url : "get-crud-list?page="+ page+"&payment_status="+payment_status+"&order_status="+order_status+"&keyword="+keyword+"&column="+ column+"&column_order="+column_order+"&ship_type="+ship_type+"&order_date_filter="+order_date_filter,
  ...
  $("body").on('click','.edit_order',function(){
    ...
    $("body").on('click','#highlight_button',function(){
            ...
            if(selectedRows.length > 0){
               ...
               $("#message").html('<div class="alert alert-danger">Please Select Row</div>');
            }
