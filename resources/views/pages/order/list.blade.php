...
<div id="loader" class="lds-dual-ring hidden overlay"></div>
    <div class="body flex-grow-1 px-3" style="font-size:12px;">
                ...
                <div class="col-md-10 col-sm-12">
                   <div class="row">
                       <div class="col-sm-12 col-md-2 py-2">
                            <select name="payment_status" id="ship_type" class="form-control">
                                <option value="" selected>Ship Type</option>
                                <option value="onlyInternational" >Only International</option>
                                 @if(! $ship_type->isEmpty())
                                         @foreach($ship_type as $ship_type_data)
                                            @if(!empty($ship_type_data->ship_type))
                                            <option value="{{ $ship_type_data->ship_type }}" >{{ $ship_type_data->ship_type }}</option>
                                            @endif
                                         @endforeach
                                 @endif
                        ...
                        <div class=" col-md-2 col-sm-12  py-2">
                            ...
                            <input type="text" class="form-control pickercalender" id="order_date_filter" placeholder="Search by Order Date">
                           
                        </div>
                        <div class=" col-md-2 col-sm-12  py-2">
                             
                            <input type="text" class="form-control" id="keyword" placeholder="Search by Order No">
                           
                        </div>
                        <div class=" col-md-2 col-sm-12  py-2">
                              <button class="btn btn-primary justify-content-end" type="button" id="search" style="margin-bottom: 20px;">Search</button>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                   <button class="btn btn-primary btn-sm justify-content-end" type="button" id="highlight_button" style="margin-bottom: 10px;">Highlight Row</button>
               </div>
